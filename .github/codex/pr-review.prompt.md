...
with `git diff <base_sha>...<head_sha>` (three dots — two would also show
changes merged into the base branch after this PR branched off, which are not
part of it) — and read enough surrounding code to
